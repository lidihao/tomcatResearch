...
public final class ContextName {
    ...
    private static final String VERSION_MARKER = "##";//版本的标识
    private static final String FWD_SLASH_REPLACEMENT = "#";

    private final String baseName;//path中的/代替#
    private final String path;//context路径
    private final String version;//版本号
    private final String name;//path+version
