...
public class CoyoteAdapter implements Adapter {
    ...
    public void service(org.apache.coyote.Request req,
        ...
        try {
            ...
            if (postParseSuccess) {
                ...
                // Calling the container
                connector.getService().getContainer().getPipeline().getFirst().invoke(request, response); //调用容器
            ...
            if (request.isAsync()) {
                ...
                try {
                    request.finishRequest(); //结束请求
                    response.finishResponse();//flush缓存
                } finally {
                    if (postParseSuccess) {
    ...
    protected boolean postParseRequest(org.apache.coyote.Request req,
        ...
        parsePathParameters(req, request);//提取路径参数

        // URI decoding
        // %xx decoding of the URL
        try {
            req.getURLDecoder().convert(decodedURI, false);//解码十六进制的url
        ...
        // Character decoding
        convertURI(decodedURI, request);//解码url
        ...
        if (connector.getUseIPVHosts()) { //是否使用基于IP的虚拟主机
    ...
    protected void parsePathParameters(org.apache.coyote.Request req,
        ...
        String enc = connector.getURIEncoding();//获取url的编码方式
        if (enc == null) {
            enc = "ISO-8859-1";
        }
        ...
        System.err.println(sm.getString("coyoteAdapter.debug", "uriBC",
                    uriBC.toString()));
        System.err.println(sm.getString("coyoteAdapter.debug", "semicolon",
                    String.valueOf(semicolon)));
        System.err.println(sm.getString("coyoteAdapter.debug", "enc", enc));
        ...
        while (semicolon > -1) {
            ...
            System.err.println(sm.getString("coyoteAdapter.debug", "pathParamStart",
                        String.valueOf(pathParamStart)));
            System.err.println(sm.getString("coyoteAdapter.debug", "pathParamEnd",
                        String.valueOf(pathParamEnd)));
            System.err.println(sm.getString("coyoteAdapter.debug", "pv", pv));
    ...
    protected void convertURI(MessageBytes uri, Request request)
        ...
        String enc = connector.getURIEncoding();//获取connect的编码方式
        if (enc != null) {
