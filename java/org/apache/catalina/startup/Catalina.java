...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        digester.setFakeAttributes(fakeAttributes);//设置fakeAttribute
        ...
        digester.addSetNext("Server",
                            "setServer",
                            "org.apache.catalina.Server");//为Catalin设置Server
        ...
        digester.addRule("Server/Service/Connector",
                         new ConnectorCreateRule());//为Connetor添加规则
        digester.addRule("Server/Service/Connector",
        ...
        // Add RuleSets for nested elements为嵌套的属性添加规则
    ...
    public void load() {
        ...
        // Create and execute our Digester 读取配置文件
